            ...
            <div className="row align-items-center">
              <div className="col-xl-2 col-lg-5 col-md-4 col-6">
                <div className="tp-header-2__logo">
                  <Link className="logo-white" href="/" style={{ textDecoration: 'none' }}>
                    <span style={{ 
                      color: 'white', 
                      fontSize: '22px', 
                      fontWeight: '700',
                  ...
                  <Link className="logo-black" href="/" style={{ textDecoration: 'none' }}>
                    <span style={{ 
                      color: '#000', 
                      fontSize: '22px', 
                      fontWeight: '700',
              ...
              <div className="col-xl-3 col-lg-7 col-md-8 col-6">
                <div className="tp-header-2__right-box d-flex align-items-center justify-content-end">
                  <div className="tp-header-2__maito d-none d-sm-block">
                    ...
                    <a href="mailto:alilatif.dev@gmail.com">alilatif.dev@gmail.com</a>
                  </div>
                  <div className="tp-header-2__bar parallax-wrap d-xl-none" onClick={() => setShowCanvas(true)}>
